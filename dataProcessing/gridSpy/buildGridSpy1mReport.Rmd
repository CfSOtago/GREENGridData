...
Of the `r tidyNum(nFiles)` files,  `r tidyNum(nFilesNotLoaded)` (`r round(100*(nFilesNotLoaded/nFiles),2)`%) were labelled as 'ignore' as their file sizes indicated that they contained no data.
