...
Finally we plot the total number of households for whom we have _any_ data on a given date (Figure \@ref(fig:attritionPlot) This gives an indication of the attrition rate. This chart is re-plotted in the [overall data package summary](ggOverviewReport.html#fig:liveDataHouseholds) coded by sample.
