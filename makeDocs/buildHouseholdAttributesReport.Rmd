...
kable(caption = "Sample location (master file)", t) %>%
  kable_styling()
```
...
kable(caption = "Sample (appliance summary file, NA indicates no data)", t) %>%
  kable_styling()
```
...
kable(caption = "Appliances recorded", al) %>%
  kable_styling()
```
...
kable(t, caption = "Survey responses (NA indicates no survey)") %>%
  kable_styling()
```
...
kable(caption = "Number of adults in household by location", t) %>%
  kable_styling()
```
...
kable(caption = "Number of teenagers in household by location", t) %>%
  kable_styling()
```
...
kable(caption = "Number of children in household by location", t) %>%
  kable_styling()
```
...
kable(caption = "Notes by location", t) %>%
  kable_styling()
```
...
```{r dataHeader}
kable(caption = "Household data: key columns", 
