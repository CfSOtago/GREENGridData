...
knitr::kable(caption = cap, head(aList, 10), digits = 2)
```
...
knitr::kable(t, caption = "Summary of household files to load", digits = 2)
```
...
```{r summaryTable}
knitr::kable(t,caption = "Summary observation stats by hhID", digits = 2)
```
...
knitr::kable(dt, caption = "Circuit labels list by number of files per household", digits = 2)
```
