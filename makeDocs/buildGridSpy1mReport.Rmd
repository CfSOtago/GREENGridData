...
## Calculating total household power demand

Unfortunately this is not as straightforward as one would wish because many households have seperately controlled (and thus monitored) hot water circuits which do not feed from the 'Incomer'. We have provided some example code to attempt to correctly sum the relevant circuits in each house. This make use of a .csv data table which specifies the circuits within each house:

 * code: kindly provided by Jason Mair
 * circuits.csv data table (see package data folder)
