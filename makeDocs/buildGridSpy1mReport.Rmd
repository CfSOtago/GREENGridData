...
# Dealing with negative power {#negPower}
...
We have conducted a [seperate analysis](checkNegativePower.html) of the incidence of negative values which makes recommendations on actions to take. 
