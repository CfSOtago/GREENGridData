 ...
 * [Report history](https://github.com/cfsotago/GREENGridData/commits/master/dataProcessing/gridSpy/buildGridSpy1mReport.Rmd)
...
To avoid confusion the data for each of these units has been split in to rf_XXa/rf_XXb files on the appropriate dates during [data processing](https://github.com/CfSOtago/GREENGridData/issues/3). The clean data therefore contains data files for:
 ...
 * kableExtra - for neat kables [@kableExtra]
