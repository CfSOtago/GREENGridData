...
=======
Figure \@ref(fig:obsPlotTile) uses a tile plot which is useful for visualising data gaps. Note that there are indications of missing observations around the end of March caused by [DST clock-changes](#dateTimeChecks).
>>>>>>> f1343d6cf871d54075a25e644924872771a480c5
...
=======
Figure \@ref(fig:obsPlotPoint) uses a point plot which is useful for visualising days where there was partial or duplicate data. Note that there are indications of duplicate observations in late October (and, strangely, the end of March 2015) caused by [DST clock-changes](#dateTimeChecks).
>>>>>>> f1343d6cf871d54075a25e644924872771a480c5
 ...
 * [code](https://github.com/CfSOtago/GREENGridData/blob/master/examples/extract_per_house_totals.r): kindly provided by Jason Mair
