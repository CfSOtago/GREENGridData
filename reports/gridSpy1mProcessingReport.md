...
date: 'Last run at: 2018-07-27 13:26:32'
output:
  html_document:
    code_folding: hide
    fig_caption: true
...
Data collection is ongoing and this section reports on the availability of data files collected up to the time at which the most recent safe file was created (2018-07-27 12:53:11).

Overall we have 2,802 files from 5 households. However a large number of files (2,125 or 75.84%) have 1 of two file sizes (43 or 2751 bytes) and we have determined that they contain no data as the monitoring devices have either been removed (households have moved or withdrawn from the study) or data transfer has failed. We therefore flag these files as 'to be ignored'.
...
Analysis completed in 9.06 seconds ( 0.15 minutes) using [knitr](https://cran.r-project.org/package=knitr) in [RStudio](http://www.rstudio.com) with R version 3.5.0 (2018-04-23) running on x86_64-apple-darwin15.6.0.
...
## [1] data.table_1.11.4      kableExtra_0.9.0       stringr_1.3.1         
## [4] knitr_1.20             readr_1.1.1            ggplot2_2.2.1         
...
## [10] yaml_2.1.19       rlang_0.2.1       pillar_1.2.3     
...
## [49] prettyunits_1.0.2 lubridate_1.7.4   assertthat_0.2.0 
## [52] httr_1.3.1        rstudioapi_0.7    R6_2.2.2         
## [55] ggmap_2.6.1       compiler_3.5.0
```
