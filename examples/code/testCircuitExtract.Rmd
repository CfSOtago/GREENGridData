...
ggplot2::ggsave(paste0(ggrParams$projLoc,"/examples/results/", params$circuit, "_meankWperminBySeason.png"))
```
...
ggplot2::ggsave(paste0(ggrParams$projLoc,"/examples/results/", params$circuit, "_meankWperminBySeason_nKids0-12.png"))
```
