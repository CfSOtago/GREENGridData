...
![](/Users/ben/github/dataknut/nzGREENGridDataR/docs/gridSpy1mProcessingReport_files/figure-html/obsPlots-1.png)<!-- -->![](/Users/ben/github/dataknut/nzGREENGridDataR/docs/gridSpy1mProcessingReport_files/figure-html/obsPlots-2.png)<!-- -->
...
Finally we plot the total number of households for whom we have data on a given date. This gives an indication of the attrition rate. This chart is re-plotted in the [overall data package summary](ggOverviewReport.html#4_data_collection_duration) coded by sample.

![](/Users/ben/github/dataknut/nzGREENGridDataR/docs/gridSpy1mProcessingReport_files/figure-html/attritionPlot-1.png)<!-- -->
