...
You will need to register for a (free) account before you can download it. Despite appearances users from outside the UK _can_ register and download the data but need to use a [specific form to request a user id](https://beta.ukdataservice.ac.uk/myaccount/credentials). Please check that the versions of the reports (below) match the version of the data you have access to.
