 ...
 * Occupant, dwelling & appliance surveys. The survey used was identical to that used in https://ourarchive.otago.ac.nz/handle/10523/5634. The pdf of the survey is also [available](EC2HouseholdSurveyAsUsedInGG.pdf) and should be read alongside the labels in [publicData](../publicData) when using the household attribute data file.
